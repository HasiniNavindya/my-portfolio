              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full sm:inline-flex items-center justify-center gap-2 bg-white text-gray-900 font-semibold px-5 py-2.5 rounded-lg hover:bg-gray-100 transition-colors text-center"
                  >
