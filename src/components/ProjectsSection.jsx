  ...
  const projects = [
    {
      ...
      github: "https://github.com/HasiniNavindya/my-portfolio",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="flex-shrink-0 w-12 h-12 rounded-full bg-white/10 border border-white/20 flex items-center justify-center hover:bg-white/20 transition disabled:opacity-30 disabled:cursor-not-allowed"
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center gap-2 bg-white text-gray-900 font-semibold px-5 py-2.5 rounded-lg hover:bg-gray-100 transition-colors"
                  >
